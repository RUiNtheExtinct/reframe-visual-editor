...
- [x] fix editor for complex react components
- [x] add borders as a feature
- [x] make the color pickers look better
- [x] add support for gradients as well
- [ ] editor code updates donot reflect in preview without reloading the page
- [ ] switching from preview to editor then back to preview breaks the formatting/color/layout
